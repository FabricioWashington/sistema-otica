...
public class Nfe extends Config {
     ...
     *
     * Atenção: Somente poderá ser cancelada uma NF-e cujo uso tenha sido
     * previamente autorizado pelo Fisco e desde que não tenha ainda ocorrido o
     * fato gerador, ou seja, ainda não tenha ocorrido a saída da mercadoria do
     * estabelecimento. Atualmente o prazo máximo para cancelamento de uma NF-e
     * é de 24 horas (1 dia), contado a partir da autorização de uso. Caso já
     * tenha passado o prazo de 24 horas ou já tenha ocorrido a circulação da
     ...
     *
     * A Carta de Correção Eletrônica (CC-e) é um evento legal e tem por
     * objetivo corrigir algumas informações da NF-e que já foi emitida.
     */
     ...
     *
     * Atenção: Somente é permitido consultar a chave da nota fiscal emitida
     * pelo emissor da WebmaniaBR, não sendo possível consultar nota fiscal de
     * terceiro ou emitida em outro sistema.
     */
     ...
     *
     * A Nota Fiscal de Ajuste é destinada somente para fins específicos de
     * escrituração contábil para empresas de Lucro Normal ou Presumido, não
     * representando saída ou entrada de produtos. Utilizado para nota de
     * crédito de ICMS como transferência, ressarcimento ou restituição do ICMS.
     */
     ...
     * não informados no documento fiscal original. Utilizado para acréscimo no
     * preço e quantidade da mercadoria ou somar valores faltantes dos impostos
     * ICMS, ICMS-ST e IPI.
     *
     * OBS: Deve ser complementado o Preço/Quantidade OU Impostos. OB2: Caso
     * deseje complementar as duas opções devem ser emitidas NF-e separadas.
     */
     ...
     * Status do Sefaz
     *
     * OBS: A utilização do endpoint deve ser realizada como demonstrativo do
     * Status do Sefaz em sua plataforma, sendo necessário trabalhar com cache
     * de ao menos 10 minutos. Não é necessário realizar a requisição antes da
     * emissão de cada Nota Fiscal, porque este procedimento é realizado de
     * forma automática em todos os endpoints.
     */
